...
module.exports.initMocks = function() {
  ...
  nock('http://127.0.0.1:5000', {"encodedQueryParams":true})
    .persist()
    .post('/api/3/action/package_search', {"q":"co2", "fq": "res_format:CSV", "rows":10,"start":10,"sort":"name asc","facet.field":["organization","groups","tags","res_format","license_id"],"facet.limit":5})
  ...
  nock('http://127.0.0.1:5000', {"encodedQueryParams":true})
    .persist()
    .post('/api/3/action/package_search', {"fq":"groups:test-group","facet.field":["organization","groups","tags","res_format","license_id"],"facet.limit":5})
  ...
  nock('http://127.0.0.1:5000', {"encodedQueryParams":true})
    .persist()
    .post('/api/3/action/package_search', {"fq":"organization:test_org_00","facet.field":["organization","groups","tags","res_format","license_id"],"facet.limit":5})
